...
city_to_country = {count:diqu for count,diqu,vele in travel_wishlist}
...
for count2, diqu, vele in travel_wishlist:
    city_to_country2[count2] = diqu

print('City to Country Mapping:', city_to_country2)